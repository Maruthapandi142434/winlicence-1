export const products = [
  ...
  },
  {
  ...
  },
   {
    ...
    productName: "Windows Server RDS",
    productId: "WS-RDS-MTH",
    sku:"6VC-03748",
    min:1,
    max: 10000000,
    users: {
  ...
  },
  {
    ...
    productName: "Windows Server RMS Device CAL",
    productId: "WS-RMS-DEV-MTH",
    ...
    sku:"CSP-DG7GMGF0PWHF-0002",
    category: "Windows Server CAL",
    productName: "Windows Server RMS User CAL",
    productId: "WS-RMS-USR-MTH",
     min:1,
    max: 10000000,
    device: {
      min: 1,
  ...
  },
  {
    ...
    category: "Windows Server CAL",
    productName: "Windows Server 1 Device CAL",
    productId: "WS-ONE-DEV-MTH",
    sku: "CSP-DG7GMGF0PWHF-0002",
    pricingModel: "fixed",
     min:1,
    max: 10000000,
  ...
  },
  {
    ...
    category: "Windows Server CAL",
    productName: "Windows Server 1 User CAL",
    productId: "WS-ONE-USR-MTH",
    sku: "CSP-DG7GMGF0PWHF-0002",
    pricingModel: "fixed",
     min:1,
    max: 10000000,
  ...
  },
  {
    ...
    category: "Windows Server CAL",
    productName: "Windows Server 1 Device CAL Lifetime",
    productId: "WS-ONE-DEV-LT",
    sku:"CSP-DG7GMGF0PWHF-0002",
    pricingModel: "fixed",
     min:1,
    max: 10000000,
  ...
  },
  {
    ...
    category: "Windows Server CAL",
    productName: "Windows Server 1 User CAL Lifetime",
    productId: "WS-ONE-USR-LT",
    sku:"CSP-DG7GMGF0PWHF-0002",
    pricingModel: "fixed",
     min:1,
    max: 10000000,
  ...
  },
  {
  ...
  },
   {
    ...
    pricingModel: "fixed",
    category: "Windows 11",
    productName: "Windows 11 Enterprise LTSC Upgrade",
    productId: "W11-ENT-LTSC-LT",
  ...
  },
  {
    ...
    Year: "2024 /2025",
    category: "Windows 11",
    productName: "Windows 11 IoT Enterprise LTSC Upgrade",
    productId: "W11-IOT-ENT-LTSC-LT",
